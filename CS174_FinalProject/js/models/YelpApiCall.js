...
function yelp_api_get(terms, near, offset, sort, category_filter, radius_filter, tl_lat, tl_long, br_lat, br_long, callback){
	...
	var auth = { 
	  ...
	  // Set #1	
	   consumerKey: "T6o8vckHur3P_NMJpQp5KA", 
	   consumerSecret: "y1PqJJMrWon9JsXmlx372nFMyvg",
	   accessToken: "7A4sN5QVS8-JI62eEaDaJhyqw-5WTbUL",
	   accessTokenSecret: "wFeA5PJOn6DHS9C22fkcOIm8si4", 
